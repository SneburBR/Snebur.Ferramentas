...
namespace Snebur.VisualStudio
{
    public class ProjetoEstilo : BaseProjeto<ConfiguracaoProjetoEstilo>
    {
        ...
        public ProjetoEstilo(ConfiguracaoProjetoEstilo configuracaoProjeto, DTE2 dte, Project projetoVS, string caminhoProjeto, string caminhoConfiguracao) :
                base(configuracaoProjeto, dte, projetoVS, caminhoProjeto, caminhoConfiguracao)
        {
        ...
        private List<FileInfo> RetornaArquivosScss(Func<FileInfo, bool> funcaoFiltroArquivoScsss, FileInfo arquivoDestino = null)
        {
            ...
            var arquivos = ProjetoUtil.RetornarTodosArquivos(this.ProjetoVS, true).Select(x => new FileInfo(x)).
