...
namespace Snebur.VisualStudio
{
    ...
    public class OrdenarTiposHeranca
    {
        ...
        public OrdenarTiposHeranca(List<Type> tipos, params Type[] tiposBase)
        {
            ...
            //this.TiposOrdenados.AddRange(this.Tipos.Except(this.TiposOrdenados));

            //if(this.Tipos.Count != this.TiposOrdenados.Count)
            //{
            //    throw new Exception("FALHA AO GERAR O DOMINIO");
            //}
        }
        ...
        {
            return this.TiposOrdenados.ToList();
        }
    }
}
