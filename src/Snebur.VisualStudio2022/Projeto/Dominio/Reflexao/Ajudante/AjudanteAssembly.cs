...
namespace Snebur.VisualStudio
{
    public static class AjudanteAssembly
    {
        ...
        public static Assembly RetornarAssembly(Project projeto)
        {
            var caminhoDll = RetornarCaminhoAssembly(projeto);
            return RetornarAssembly(caminhoDll);
        }
        ...
        public static string RetornarCaminhoAssembly(Project projeto)
        {
            ...
            throw new FileNotFoundException($"Não foi encontrada a DLL debug do projeto {projeto.Name} - caminho : {caminhoDll} ");
        }
