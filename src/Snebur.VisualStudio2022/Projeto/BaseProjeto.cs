...
namespace Snebur.VisualStudio
{
    public abstract class BaseProjeto : Snebur.Dominio.BaseViewModel, IDisposable
    {
        ...
        public BaseProjeto(DTE2 dte, Project projetoVS, string caminhoProjeto, string caminhoConfiguracao)
        {
            this.DTE = dte;
        ...
        public void NormalizarReferencias(bool compilar)
        {
            ...
            {
                LogVSUtil.LogErro(new Exception($"Não foi possivel atualizar o projeto {this.NomeProjeto}", ex));
            }
        }
    ...
    public abstract class BaseProjeto<TConfiguracaoProjeto> : BaseProjeto where TConfiguracaoProjeto : ConfiguracaoProjeto
    {
        ...
        public BaseProjeto(TConfiguracaoProjeto configuracaoProjeto, DTE2 dte, Project projetoVS, string caminhoProjeto, string caminhoConfiguracao) :
                          base(dte, projetoVS, caminhoProjeto, caminhoConfiguracao)
        {
