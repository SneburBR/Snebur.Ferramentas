...
namespace Snebur.VisualStudio
{
    public class ProjetoContextoDados : BaseProjeto<ConfiguracaoProjetoContextoDados>
    {
        ...
        public ProjetoContextoDados(ConfiguracaoProjetoContextoDados configuracaoProjeto, DTE2 dte, Project projetoVS, string caminhoProjeto, string caminhoConfiguracao) :
