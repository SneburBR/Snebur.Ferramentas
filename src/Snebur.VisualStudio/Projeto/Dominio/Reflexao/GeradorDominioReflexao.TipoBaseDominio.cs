...
namespace Snebur.VisualStudio.Projeto.Dominio
{
    public partial class GeradorDominioReflexao
    {
        ...
        private string RetornarDeclaracaoTipoBaseDominio(Type tipo, string _namespace)
        {
            ...
            var retorno = String.Format("var {0} = new Snebur.Reflexao.TipoBaseDominio({1}, \"{2}\", \"{3}\",\"{4}\",{5}, {6});",
        ...
        private string RetornarDeclaracaoListaTipoBaseDominio(Type tipo, string _namespace)
        {
            ...
            var retorno = String.Format("var {0} = new Snebur.Reflexao.TipoListaBaseDominio(\"{1}\", \"{2}\", \"{3}\",{4});",
        ...
        private string RetornarAdicionarTiposBaseDominio()
        {
            ...
            if (this.ProjetoSneburDominio)
            {
                var caminhoTipo = TipoUtil.RetornarCaminhoTipo(AjudanteAssembly.TipoBaseDominio);
