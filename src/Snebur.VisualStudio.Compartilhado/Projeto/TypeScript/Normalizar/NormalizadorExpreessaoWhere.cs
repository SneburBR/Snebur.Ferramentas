...
{
    internal abstract class BaseNormalizadorExpreessaoWhere : IDisposable
    {
        protected string Expressao;
        protected const string METODO_STARTS_WITH = "StartsWith";
        protected const string METODO_EQUALS = "Equals";
        protected const string METODO_ENDS_WITH = "EndsWith";
        ...
        internal BaseNormalizadorExpreessaoWhere(string expressao)
        {
            this.Expressao = expressao;
        }

        internal abstract bool IsNormalizarExpressaoWhere { get; }
    ...
    internal class NormalizadorExpreessaoWhere : BaseNormalizadorExpreessaoWhere
    {
        ...
        internal override bool IsNormalizarExpressaoWhere
        {
            get
            {
                ...
                if (expressao.Contains("function") && expressao.Contains("return") && !expressao.Contains(EXPRESSAO_NORMALIZADA))
                {
        ...
        internal NormalizadorExpreessaoWhere(string expressao):base(expressao)
        {
